...
QT_MOC_LITERAL(1, 11, 15), // "NewDataReceived"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 5), // "Dummy"
QT_MOC_LITERAL(4, 34, 9) // "ReadyRead"

    },
    "UDPHandler\0NewDataReceived\0\0Dummy\0"
    "ReadyRead"
};
...
void UDPHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (UDPHandler::*)(QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UDPHandler::NewDataReceived)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UDPHandler::Dummy)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void UDPHandler::NewDataReceived(QByteArray _t1)
{
