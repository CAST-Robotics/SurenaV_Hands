...
if("FALSE" STREQUAL "TRUE")
  set(offlinepublisher_SOURCE_PREFIX /home/cast/surenaIV/src/offlinePublisher)
  set(offlinepublisher_DEVEL_PREFIX /home/cast/surenaIV/devel)
  ...
  set(offlinepublisher_INSTALL_PREFIX /home/cast/surenaIV/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'offlinepublisher' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT offlinepublisher_NUM_DUMMY_TARGETS)
      set(offlinepublisher_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::offlinepublisher::wrapped-linker-option${offlinepublisher_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR offlinepublisher_NUM_DUMMY_TARGETS "${offlinepublisher_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::offlinepublisher::wrapped-linker-option${offlinepublisher_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND offlinepublisher_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(offlinepublisher_EXPORTED_TARGETS ${${offlinepublisher_dep}_EXPORTED_TARGETS})
endforeach()
