...
set(MSG_I_FLAGS "-Iofflinepublisher:/home/cast/surenaIV/src/offlinePublisher/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/cast/surenaIV/src/offlinePublisher/msg/num.msg" NAME_WE)
add_custom_target(_offlinepublisher_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "offlinepublisher" "/home/cast/surenaIV/src/offlinePublisher/msg/num.msg" ""
)

get_filename_component(_filename "/home/cast/surenaIV/src/offlinePublisher/srv/srv1.srv" NAME_WE)
add_custom_target(_offlinepublisher_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "offlinepublisher" "/home/cast/surenaIV/src/offlinePublisher/srv/srv1.srv" ""
)
...
_generate_msg_cpp(offlinepublisher
  "/home/cast/surenaIV/src/offlinePublisher/msg/num.msg"
  "${MSG_I_FLAGS}"
  ""
...
_generate_srv_cpp(offlinepublisher
  "/home/cast/surenaIV/src/offlinePublisher/srv/srv1.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/offlinepublisher
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/offlinepublisher)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/offlinepublisher\")")
  # install generated code
  install(
