...
(cl:defmethod cl:initialize-instance :after ((m <active_csp-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'active_csp-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name surena_eth-srv:<active_csp-request> is deprecated: use surena_eth-srv:active_csp-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <active_csp-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'active_csp-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name surena_eth-srv:<active_csp-response> is deprecated: use surena_eth-srv:active_csp-response instead.")))
