...
(cl:defmethod cl:initialize-instance :after ((m <home-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'home-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_teleop-srv:<home-request> is deprecated: use robot_teleop-srv:home-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <home-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'home-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_teleop-srv:<home-response> is deprecated: use robot_teleop-srv:home-response instead.")))
