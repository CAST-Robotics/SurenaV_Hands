...
(cl:defmethod cl:initialize-instance :after ((m <reset_node-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'reset_node-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name surena_eth-srv:<reset_node-request> is deprecated: use surena_eth-srv:reset_node-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <reset_node-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'reset_node-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name surena_eth-srv:<reset_node-response> is deprecated: use surena_eth-srv:reset_node-response instead.")))
